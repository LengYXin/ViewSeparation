...
export default class PageStore {
  ...
  async onInsert(params) {
    ...
    notification.success({ message: getLocalesValue('tips.success.operation'), description: "" });
    this.onSearch();
    return res;
  }
  /** 修改 */
  ...
  async onDelete(params: string[]) {
    ...
    try {
      ...
      this.PageState.tableLoading = false;
      notification.error({ message: getLocalesValue('tips.error.operation'), description: ""  });
    }
  }
  /**
   * 导入
